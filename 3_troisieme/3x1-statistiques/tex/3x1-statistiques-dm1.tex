...
\begin{itemize}
	\item[1.] Un des deux graphiques est faux et ne respecte pas le principe de proportionnalité de sur l'echelle des ordonnées. Lequel ? \textbf{(Justifier !)}
	\item[2.] Représenter à nouveau les \textbf{deux} graphiques avec des diagrammes en bâton, mais cette fois juste.
\end{itemize}	

\subsection*{Bonus}

Bravo, vous êtes meilleurs en mathématiques qu'un journaliste de BFM. À moins que... \\
